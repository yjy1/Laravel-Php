...
@section('content')
    ...
    <div class="am-g am-g-fixed blog-fixed">
        <div class="am-u-md-8 am-u-sm-12">
            ...
            @foreach($main_art as $a)
                <article class="am-g blog-entry-article">
                    <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-img">
                        <a href="{{url('article/'.$a->art_id)}}"><img src="{{$a->art_thumb}}" alt="" class="am-u-sm-12"></a>
                    </div>
                    <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-text">
                        <span><a href="" class="blog-color">{{$a->art_tag}}&nbsp;</a></span>
                        <span> By {{$a->art_editor}} &nbsp;</span>
                        <span>{{date('Y-m-d H:i:s',$a->art_time)}}</span>
                        <h1><a href="{{url('article/'.$a->art_id)}}">{{$a->art_title}}</a></h1>
                        <p>
                            {{$a->art_desc}}
                        </p>

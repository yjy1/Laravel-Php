...
{{--    --}}
    <form action="{{url('admin/navs')}}" method="post" class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="nav_order" id="" placeholder="" value="" class="input-text">
            </div>
        </div>

...
@section('content')
    ...
    <div class="page-container">
        <form action="{{url('admin/navs/'.$data->nav_id)}}" method="post" class="form form-horizontal"
              id="form-article-add">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{$data->nav_name}}" placeholder="" id=""
                           name="nav_name">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{$data->nav_alias}}" placeholder="" id=""
                           name="nav_alias">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{$data->nav_url}}" placeholder="" id=""
                           name="nav_url">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" name="nav_order" id="" placeholder="" value="{{$data->nav_order}}"
                           class="input-text">
                </div>
            </div>

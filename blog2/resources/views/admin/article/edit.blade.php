...
@section('content')
    ...
    <div class="page-container">
        <form action="{{url('admin/article/'.$articles->art_id)}}" method="post" class="form form-horizontal"
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{$articles->art_title}}" placeholder="" id=""
                           name="art_title">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{$articles->art_tag}}" placeholder="" id=""
                           name="art_tag">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{$articles->art_desc}}" placeholder="" id=""
                           name="art_desc">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="file" type="file" value="" class="form-control" name="source" required>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <textarea type="text" name="art_content" id="art_content" placeholder="" >{{$articles->art_content}}</textarea>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" name="art_editor" id="" placeholder="" value="{{$articles->art_editor}}"
                           class="input-text">
                </div>
            </div>

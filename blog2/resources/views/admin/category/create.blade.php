...
{{--    --}}
    <form action="{{url('admin/category')}}" method="post" class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="cate_desc" cols="" rows="" class="textarea"  placeholder=" " onKeyUp="$.Huitextarealength(this,100)"></textarea>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="cate_order" id="" placeholder="" value="" class="input-text">
            </div>
        </div>
